...
function traerInformacionAdmin(){
    $.ajax({
        url:"http://193.122.181.170:8080/api/Admin/all", //colocar la http del modulo de la tabla CLIENT
        type:"GET",
        datatype:"JSON",
...
function guardarElementoAdmin(){
    ...
    $.ajax({
        ...
        url:"http://193.122.181.170:8080/api/Admin/save",
...
function actualizarElementoAdmin(idElemento){
    ...
    $.ajax({
        url:"http://193.122.181.170:8080/api/Admin/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoAdmin(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://193.122.181.170:8080/api/Admin/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
