...
function traerInformacionReporteStatus(){
    $.ajax({
        url:"http://193.122.181.170:8080/api/Reservation/report-status",
        type:"GET",
        datatype:"JSON",
...
function traerInformacionReporteFechas() {
    ...
    $.ajax({
        url: "http://193.122.181.170:8080/api/Reservation/report-dates/" + inicialDate + "/" + finalDate,
        type: "GET",
        datatype: "JSON",
...
function traerInformacionReporteClient(){
    $.ajax({
        url:"http://193.122.181.170:8080/api/Reservation/report-clients", //colocar la http del modulo de la tabla CLIENT
        type:"GET",
        datatype:"JSON",
