...
function traerInformacionC(){
    $.ajax({
        url:"http://193.122.181.170:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
...
function traerInformacionReservation(){
    $.ajax({
        url:"http://193.122.181.170:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElementoReservation(){
    ...
    $.ajax({
        ...
        url:"http://193.122.181.170:8080/api/Reservation/save",
...
function actualizarElementoReservation(idElemento){
    ...
    $.ajax({
        url:"http://193.122.181.170:8080/api/Reservation/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoReservation(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://193.122.181.170:8080/api/Reservation/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
