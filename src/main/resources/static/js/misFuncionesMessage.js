...
function traerInformacionMessage(){
    $.ajax({
        url:"http://193.122.181.170:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function guardarElementoMessage(){
    ...
    $.ajax({
        ...
        url:"http://193.122.181.170:8080/api/Message/save",
...
function actualizarElementoMessage(idElemento){
    ...
    $.ajax({
        url:"http://193.122.181.170:8080/api/Message/update", //colocar la http del modulo de la tabla CLIENT
        type:"PUT",
        data:dataToSend,
...
function borrarElementoMessage(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://193.122.181.170:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
